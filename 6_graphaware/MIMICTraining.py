...
class MIMICTraining:
    ...
    def get_node_split_containers(self, connector):
        self.train_split_info = NodeSplitInformation(connector.get_ids('MIMIC_TRAIN'), self.train_label_name, "")
        self.val_split_info = NodeSplitInformation(connector.get_ids('MIMIC_VAL'), self.val_label_name, "")
        self.test_split_info = NodeSplitInformation(connector.get_ids('MIMIC_TEST'), self.test_label_name, "")
