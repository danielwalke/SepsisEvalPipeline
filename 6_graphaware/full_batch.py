...
def optimize_hyperparams(session):
    ...
    'scale_pos_multiplier': hp.uniform('scale_pos_multiplier', 0.5, 2.0)
    }
    
    def objective(params):
        train_cond = "WHERE toInteger(n.patientId) % 10 < 8"
        val_cond = "WHERE toInteger(n.patientId) % 10 = 8"
        ...
        base_balanced_weight = float(negative_count / positive_count)
        
        tuned_weight = base_balanced_weight * params['scale_pos_multiplier']
